...
function cadastrarDespesa(){
	...
	if (despesa.validarDados()) {
		...
		//zerando os campos para inserção de novos dados
		ano.value = ''
		mes.value = ''
		dia.value = ''
		tipo.value = ''
		...
		document.getElementById('exampleModalLabel1').innerHTML = 'Erro na gravação'
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
	...
	despesas.forEach(function(d){
		...
		//criando a linha (tr)
		let linha = listaDespesas.insertRow() //esse método insere uma linha a cada interação do forEach na tabela listaDespesas

		//criar as colunas(td)
		linha.insertCell(0).innerHTML = `${d.dia}/${d.mes}/${d.ano}` //esse método cria as colunas e como parâmetro um valor.
